...
// $zoom['config']['galleryThumbDesc'] = function($pic_list_data, $k){return $pic_list_data[$k]['imgSize'][0].' x '.$pic_list_data[$k]['imgSize'][1];}
...
$zoom['config']['txt'][0]['fontText'] = "Copyright 2001-2021\n\"Your Company\"\n"; // string
