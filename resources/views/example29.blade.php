...
<html itemscope="itemscope" itemtype="https://schema.org/WebPage">
    <head>
        ...
        <script type="text/javascript" src="{{asset('axZm/plugins/jquery-1.8.3.min.js')}}"></script>

        <!--  AJAX-ZOOM javascript -->
        <script type="text/javascript" src="{{asset('axZm/jquery.axZm.js')}}"></script>
        <link type="text/css" href="{{asset('axZm/axZm.css')}}" rel="stylesheet" />

        <!-- JavaScript for 360/3D gallery -->
        <script type="text/javascript" src="{{asset('axZm/extensions/jquery.axZm.360Gallery.js')}}"></script>
        <link rel="stylesheet" type="text/css" href="{{asset('axZm/extensions/jquery.axZm.360Gallery.css')}}" />

        <!-- Include axZm.thumbSlider -->
        <link rel="stylesheet" type="text/css" href="{{ asset('axZm/extensions/axZmThumbSlider/skins/default/jquery.axZm.thumbSlider.css') }}"/>
        <script type="text/javascript" src="{{ asset('axZm/extensions/axZmThumbSlider/lib/jquery.mousewheel.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('axZm/extensions/axZmThumbSlider/lib/jquery.axZm.thumbSlider.js') }}"></script>
    ...
    <body>
        <div id="headerNavi" style="width: 386px; z-index: 2147483647; position: absolute; left: 50%; top: 0; margin-left: -193px;">
            <?php
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                jQuery.axZm360Gallery ({
                    ...
                    galleryData: [
                        ["imageZoom", "/storage/building.jpg"],
